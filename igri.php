...
FROM chet, sotr, game where idsotr=$sotr and datechet>'$d' and idsotrg=$sotr and idplg=idchet and gamestat=0 and rez=1");
...
$res=mysql_query("SELECT namekl, imagekl, nomer, nameigra, datechet, idchet, timeigra, idplg
FROM chet, klient, sotr, game where idsotr=$sotr and datechet>'$d' and $sotr=idsotrg and idplg=idchet and idklientchet=idklient and gamestat=0 and rez=1");
